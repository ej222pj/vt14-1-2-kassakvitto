    ...
    <form id="form1" runat="server">
        <div>
            <div class="main">
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="receipt" Visible="false">
                    ...
                    <p>Öppetider: 24/7</p>
                    <p>~~~~~~~~~~~~~~~~~~~~~~</p>
                    <p class="pricename">Totalt: </p>
                    <p>
                        <asp:Label ID="labelSubtotal" runat="server" Text="" CssClass="pricestyle"></asp:Label></p>
                    <p class="pricename">Rabattsats: </p>
                    <p>
                        <asp:Label ID="labelDiscountRate" runat="server" Text="" CssClass="pricestyle"></asp:Label></p>
                    <p class="pricename">Rabatt: </p>
                    <p>
                        <asp:Label ID="labelMoneyOff" runat="server" Text="" CssClass="pricestyle"></asp:Label></p>
                    <p class="pricename">Att betala: </p>
                    <p>
                        <asp:Label ID="labelTotal" runat="server" Text="" CssClass="pricestyle"></asp:Label></p>
                    <p>~~~~~~~~~~~~~~~~~~~~~~</p>
